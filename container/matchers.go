...
// Looks up *docker.APIContainer that matches *DockerContainer passed as parameter and
// calls an anonymous func on it
func withDockerAPIContainer(c *DockerContainer, fn func(*docker.APIContainers) error) error {
	return withDockerClient(func(client *docker.Client) error {
...
func IsDockerImgPresent(img *DockerImg) error {
...
// It returns an error if it was not found
func IsDockerContainerPresent(c *DockerContainer) error {
